...
class ParkingFinder(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(
            QgsProcessingParameterNumber(
                self.INPUT_BUFFER,
                self.tr('Buffer in feet: (maximum is 100000)'),
                QgsProcessingParameterNumber.Double,
                minValue=1,
                maxValue=100000
            )
        ...
        self.addParameter(
            QgsProcessingParameterNumber(
                ...
                self.tr('Number of Results: (Maximum is 25)'),
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        feedback.pushInfo(f'{lat} {lon} {buffer}')
        ...
        parkingElements= [[each.tags(),each.geometry()] for each in parking.elements()]
        ...
        #attribute prep
        parkingDetails = ["name","access", "building","building:levels","parking","capacity","fee"]
        fields = QgsFields()
